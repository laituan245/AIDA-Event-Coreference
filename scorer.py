...
def aida_evaluate(model, eval_set, configs, verbose=True):
    predictions = []
    ...
    with tempfile.NamedTemporaryFile(delete=False, mode='w') as prediction_file:
        ...
        summary = { m: official_conll_eval('resources/AIDA/ground_truth.conll', prediction_file.name, m) for m in metrics}
